namespace Devises.Domain.Tests.GraphSpecs
{
    ...
    public class ShouldReturnShortestComplexPath
    {
        ...
        public void WhenRouteIsStraightForward()
        {
            ...
            sut.Add(new ExchangeRate(Currencies.Dollar, Currencies.Yen, new Rate(2.5m)));
            sut.Add(new ExchangeRate(Currencies.Yen, Currencies.Yuan, new Rate(3m)));
            sut.Add(new ExchangeRate(Currencies.Dollar, Currencies.Yuan, new Rate(3.5m)));
